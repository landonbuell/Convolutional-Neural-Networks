...
if __name__ == '__main__':
    ...
    Vis_utils.Plot_Metrics([BASELINE,MUTE_MSB],'single_layer',title="Single Hidden Layer Models",show=True)
    Vis_utils.Plot_Metrics([BASELINE,MUTE_MSB],'double_layer',title="Double Hidden Layer Models",show=True)
    Vis_utils.Plot_Metrics([BASELINE,MUTE_MSB],'triple_layer',title="Triple Hidden Layer Models",show=True)
    Vis_utils.Plot_Metrics([BASELINE,MUTE_MSB],'quadruple_layer',title="Quadruple Hidden Layer Models",show=True)
