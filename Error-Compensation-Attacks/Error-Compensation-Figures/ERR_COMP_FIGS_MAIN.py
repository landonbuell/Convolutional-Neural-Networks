...
if __name__ == '__main__':
    ...
    utils.Plot_Metrics('LossValue4Pixels','Loss Function Value',data,
                       'loss',True,False)
    ...
    data = [filedata[x] for x in cols]
    utils.Plot_Metrics('PrecisionScore4Pixels','Precision Score Value',data,
    ...
    data = [filedata[x] for x in cols]
    utils.Plot_Metrics('RecallScore4Pixels','Recall Score Value',data,
                       'recall',True,False)
    ...
    utils.Plot_PercentDiff('TrainingPercentDifference','Fitting-Time Difference',
                           labs=filedata.columns,ydata=dt,save=True,show=False)
    ...
    utils.Plot_PercentDiff2('CompensationTimePercent','Compensation-Layer Time Usage',
                            labels,plot_data,True,False)
